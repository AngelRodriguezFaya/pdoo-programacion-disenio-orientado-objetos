...
public class Game {
    ...
    private void configureLabyrinth(){
        ...
        labyrinth.addBlock(Orientation.HORIZONTAL, 0, 4, 3);
        labyrinth.addBlock(Orientation.HORIZONTAL, 0, 0, 1);
        labyrinth.addBlock(Orientation.HORIZONTAL, 1, 1, 1);
        labyrinth.addBlock(Orientation.HORIZONTAL, 5, 0, 3);
        labyrinth.addBlock(Orientation.VERTICAL, 6, 2, 1);
        labyrinth.addBlock(Orientation.VERTICAL, 5, 6, 3);
        labyrinth.addBlock(Orientation.VERTICAL, 4, 5, 2);
    ...
    private void nextPlayer(){
        if(!players.isEmpty()){ // Si el contenedor de jugadores no está vacío.
            this.currentPlayerIndex++;
            if(currentPlayerIndex >= players.size()) { // Si el índice del jugador actual es mayor que el tamaño del contenedor
                currentPlayerIndex = 0; // Vuelve al primer juagdor si excede el tamaño.
            }
